            ...
            <form action="" className='bg-stone-100 p-8 w-[56%] rounded shadow-sm'>
                <div className='grid grid-rows-[1fr_auto_auto] gap-2'>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <textarea name="" id="textarea_input" className='mt-1 resize-none border-1 rounded focus:outline-0 p-2' placeholder='Write your message here...'></textarea>
